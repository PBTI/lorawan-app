                ...
                if((input[i].Split(':'))[0] == "\"fPort\"")
                    switch(input[i].Split(':')[1])
                    {
                        case "30":
                            ...
                            float buff = System.BitConverter.ToSingle(data, 3);
                            result += "Temperature : " + buff + "\n";
                            buff = System.BitConverter.ToSingle(data, 7);
                        ...
                        case "9":
                            ...
                            float buff2 = System.BitConverter.ToSingle(data2, 2);
                            result2 += "\nTemperature : " + buff2 + "\n";
                            buff2 = System.BitConverter.ToSingle(data2, 6);
